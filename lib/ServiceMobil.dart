...
class ServiceMobil extends StatefulWidget {
  const ServiceMobil({super.key});

  @override
  _ServiceMobilState createState() => _ServiceMobilState();
}

class _ServiceMobilState extends State<ServiceMobil> {
  ...
  final List<String> teknisiOptions = ['John', 'Doe', 'Jane', 'Smith', 'David', 'Johnson', 'Fiqri', 'Putra', 'Qodri', 'Fajar', 'Fikri'];
