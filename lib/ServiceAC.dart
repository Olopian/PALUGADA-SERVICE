...
import 'Servisan.dart'; // Import the Servisan file
import 'ChatTeknisi.dart';
import 'Akun.dart';

class ServiceAC extends StatefulWidget {
  const ServiceAC({super.key});

  @override
  _ServiceACState createState() => _ServiceACState();
}

class _ServiceACState extends State<ServiceAC> {
  ...
  final List<String> teknisiOptions = ['Evindo', 'Mamat', 'Lutfi', 'Olo', 'Pian', 'Malau', 'Ramadhan', 'Bambang', 'Khairul', 'Anto', 'Andika', 'Suprapto'];
                    ...
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        ...
                        Future.delayed(const Duration(seconds: 2), () {
                          ...
                          // Kembali ke halaman home setelah proses selesai
                          Navigator.push(
                            context,
                            MaterialPageRoute(
