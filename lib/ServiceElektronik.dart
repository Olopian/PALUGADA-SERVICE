...
class ServiceElektronik extends StatefulWidget {
  const ServiceElektronik({super.key});

  @override
  _ServiceElektronikState createState() => _ServiceElektronikState();
}

class _ServiceElektronikState extends State<ServiceElektronik> {
  ...
  final List<String> teknisiOptions = ['Handi', 'Melky', 'David', 'Fahri', 'Fahrul', 'Fajar', 'Feri', 'Fikri', 'Fakhri'];
